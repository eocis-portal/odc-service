from .styles.landcover_historical_style import style as landcover_historical_style
...
layer = {
    ...
    "name": "chuk_landcover_historical",
    # The ODC product name for the associated data product
    "product_name": "chuk_landcover_historical",
    ...
    "styling": {
        ...
        "default_style": "landcover_historical_style",
