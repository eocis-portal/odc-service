from .styles.suburban_builtarea_style import style as suburban_builtarea_style
...
layer = {
    ...
    "title": "CHUK - Suburban Built Area Fractions",
    "abstract": "Estimates of Urban and Suburban built area fractions on the CHUK grid",
    ...
    "name": "chuk_builtarea_suburban",
    # The ODC product name for the associated data product
    "product_name": "chuk_builtarea",
    ...
    "styling": {
        ...
        "default_style": "suburban_builtarea_style",
