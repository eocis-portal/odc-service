from .styles.urban_builtarea_style import style as urban_builtarea_style
...
layer = {
    ...
    "title": "CHUK - Urban Built Area Fractions",
    "abstract": "Estimates of Urban built area fractions on the CHUK grid",
    ...
    "styling": {
        ...
        "default_style": "urban_builtarea_style",
