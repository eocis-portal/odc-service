from .styles.ice_sheet_sec_style import style as ice_sheet_sec_style
...
layer = {
    ...
    "name": "ice_sheet_monthly",
    # The ODC product name for the associated data product
    "product_name": "ice_sheet_monthly",

    "default_time": "2020-06-01",
    "time_axis": {
        "time_interval": 1,
    ...
    "styling": {
        ...
        "default_style": "ice_sheet_sec_style",
