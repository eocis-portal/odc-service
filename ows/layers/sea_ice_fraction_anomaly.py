from .styles.sea_ice_fraction_anomaly_style import style as sea_ice_fraction_anomaly_style
...
layer = {
    ...
    "bands": { "sea_ice_fraction_anomaly": [] },
    ...
    "styling": {
        "default_style": "sea_ice_fraction_anomaly_style",
        "styles": [
            sea_ice_fraction_anomaly_style
        ]
    }
}